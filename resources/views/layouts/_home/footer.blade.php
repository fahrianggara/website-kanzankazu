                            ...
                            <div class="post-item clearfix">
                                ...
                                <div class="post-info">
                                    <div class="post-title loading">
                                        <a href="{{ route('blog.detail', ['slug' => $post->slug]) }}"
                                            class="m-0 text-links underline {{ request()->is('blog/' . $post->slug) ? 'active' : '' }}">
                    ...
                    <div class="row footer-links">
                        <ul class="col-lg-6 col-md-6">
                            ...
                            <li><i class="uil uil-angle-right"></i>
                                <a class="underline" href="#about">{{ trans('home.navbar.about') }}</a>
                            </li>
                            <li><i class="uil uil-angle-right"></i>
                                <a class="underline" href="#gallery">{{ trans('home.navbar.gallery') }}</a>
                            </li>
                            <li><i class="uil uil-angle-right"></i>
                                <a class="underline" href="#contact">{{ trans('home.navbar.contact') }}</a>
                            </li>
                        </ul>
