    ...
    <div class="media-body">
        ...
        <div class="body">
                    ...
                    <div class="comTitle loading">
                        <div class="comment-title guestName" style="font-family: 'Rubik', sans-serif;">
                                    ...
                                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-5 py-1">
                                        @can('reply-to-comment', $comment)
                                            <button data-toggle="modal" data-target="#reply-modal-{{ $comment->getKey() }}"
                                                ...
                                                <i class="uil uil-share text-primary"></i>
                            ...
                            <div class="small text-secondary">
                                ...
                                @if ($comment->guest_name != null) Guest Comment • @endif {{ $comment->created_at->longAbsoluteDiffForHumans() }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="loading comText" style="margin-top: 1px">
                ...
                {{-- <div class="comment-text commentMsg">{!! $comment->comment !!} </div> --}}
            </div>
        </div>
                        ...
                        <form id="formCommentUpdate" method="POST" class="form-modal-comment"
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <textarea id="message" class="form-control" required name="message" rows="8" autofocus>{{ $comment->comment }}</textarea>
        ...
        @can('reply-to-comment', $comment)
            <div class="modal fade modalReplay" id="reply-modal-{{ $comment->getKey() }}"
                data-key="{{ $comment->getKey() }}" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-centered">
