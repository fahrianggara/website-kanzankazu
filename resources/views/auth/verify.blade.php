            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{ __('Sebelum melanjutkan.. harap periksa email kamu untuk mengaktifkan email verifikasi di website kami.') }}
                        {{ __('Jika kamu tidak menerima tautan verifikasi dari kami') }}.
