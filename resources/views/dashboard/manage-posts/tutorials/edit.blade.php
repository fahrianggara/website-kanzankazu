...
@section('breadcrumbs')
    {{ Breadcrumbs::render('edit_tutorial', $tutorial) }}
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-30">
                <form action="{{ route('tutorials.update', ['tutorial' => $tutorial]) }}#posts" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <input type="text" name="slug" id="tutorial_slug"
                                    ...
                                    value="{{ old('slug', $tutorial->slug) }}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="cate_desc"
                                onkeyup="countChar(this)" cols="2" rows="6" placeholder="Masukkan deskripsi tutorial..">{{ old('description', $tutorial->description) }}</textarea>
                    ...
                    <div class="card-footer">
                        {{-- Button Save --}}
                        <a class="btn btn-info px-4" href="{{ route('tutorials.index') }}#posts">Kembali</a>
