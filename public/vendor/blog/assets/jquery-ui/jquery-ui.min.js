...
! function (t) {
    ...
    V.cleanData = (n = V.cleanData, function (t) {
        ...
        var s, n, o, a = {},
            r = t.split(".")[0],
            h = r + "-" + (t = t.split(".")[1]);
        return e || (e = i, i = V.Widget), Array.isArray(e) && (e = V.extend.apply(null, [{}].concat(e))), V.expr.pseudos[h.toLowerCase()] = function (t) {
            return !!V.data(t, h)
    ...
    x = Math.max, k = Math.abs, o = /left|center|right/, h = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, c = /^\w+/, u = /%$/, C = V.fn.position, V.position = {
        ...
        return _[0].preventDefault && (u.at = "left top"), p = e.width, f = e.height, m = V.extend({}, g = e.offset), V.each(["my", "at"], function () {
            ...
            (i = 1 === i.length ? o.test(i[0]) ? i.concat(["center"]) : h.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = o.test(i[0]) ? i[0] : "center", i[1] = h.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], u[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
            ...
            var i, t, a = V(this),
                ...
                o = h + s + I(this, "marginBottom") + b.height,
                l = V.extend({}, m),
            ...
            "right" === u.my[0] ? l.left -= r : "center" === u.my[0] && (l.left -= r / 2), "bottom" === u.my[1] ? l.top -= h : "center" === u.my[1] && (l.top -= h / 2), l.left += c[0], l.top += c[1], i = {
                ...
                V.ui.position[y[t]] && V.ui.position[y[t]][e](l, {
                    targetWidth: p,
                    targetHeight: f,
                    elemWidth: r,
                    elemHeight: h,
                ...
                p < r && k(e + i) < p && (o.horizontal = "center"), f < h && k(s + n) < f && (o.vertical = "middle"), x(k(e), k(i)) > x(k(s), k(n)) ? o.important = "horizontal" : o.important = "vertical", u.using.call(this, t, o)
            }), a.offset(V.extend(l, {
                using: t
            }))
        })
    ...
    V.ui.resizable, V.widget("ui.selectable", V.ui.mouse, {
        ...
        _getItemsAsjQuery: function (t) {
            ...
            }) : V(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), e = a.length - 1; 0 <= e; e--) a[e][0].each(h);
            return V(o)
        },
        ...
        _refreshItems: function (t) {
            ...
            for (e = c.length - 1; 0 <= e; e--)
                for (o = c[e][1], h = (a = c[e][i = 0]).length; i < h; i++)(r = V(a[i])).data(this.widgetName + "-item", o), l.push({
                    item: r,
                    instance: o,
                    width: 0,
                    height: 0,
        ...
        _contactContainers: function (t) {
            for (var e, i, s, n, o, a, r, h, l, c = null, u = null, d = this.containers.length - 1; 0 <= d; d--) V.contains(this.currentItem[0], this.containers[d].element[0]) || (this._intersectsWith(this.containers[d].containerCache) ? c && V.contains(this.containers[d].element[0], c.element[0]) || (c = this.containers[d], u = d) : this.containers[d].containerCache.over && (this.containers[d]._trigger("out", t, this._uiHash(this)), this.containers[d].containerCache.over = 0));
            if (this.innermostContainer = c)
                if (1 === this.containers.length) this.containers[u].containerCache.over || (this.containers[u]._trigger("over", t, this._uiHash(this)), this.containers[u].containerCache.over = 1);
                    ...
                    for (i = 1e4, s = null, n = (h = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", o = h ? "width" : "height", l = h ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) V.contains(this.containers[u].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (a = this.items[e].item.offset()[n], r = !1, t[l] - a > this.items[e][o] / 2 && (r = !0), Math.abs(t[l] - a) < i && (i = Math.abs(t[l] - a), s = this.items[e], this.direction = r ? "up" : "down"));
    ...
    V.extend(V.ui, {
        ...
        setDefaults: function (t) {
            return T(this._defaults, t || {}), this
        },
        ...
        _dialogDatepicker: function (t, e, i, s, n) {
            ...
            return a || (this.uuid += 1, o = "dp" + this.uuid, this._dialogInput = V("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), V("body").append(this._dialogInput), (a = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, V.data(this._dialogInput[0], "datepicker", a)), T(a.settings, s || {}), e = e && e.constructor === Date ? this._formatDate(a, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, this._pos || (o = document.documentElement.clientWidth, s = document.documentElement.clientHeight, e = document.documentElement.scrollLeft || document.body.scrollLeft, n = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [o / 2 - 100 + e, s / 2 - 150 + n]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), a.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), V.blockUI && V.blockUI(this.dpDiv), V.data(this._dialogInput[0], "datepicker", a), this
        },
        ...
        _optionDatepicker: function (t, e, i) {
            ...
            s = e || {}, "string" == typeof e && ((s = {})[e] = i), o && (this._curInst === o && this._hideDatepicker(), n = this._getDateDatepicker(t, !0), e = this._getMinMaxDate(o, "min"), i = this._getMinMaxDate(o, "max"), T(o.settings, s), null !== e && void 0 !== s.dateFormat && void 0 === s.minDate && (o.settings.minDate = this._formatDate(o, e)), null !== i && void 0 !== s.dateFormat && void 0 === s.maxDate && (o.settings.maxDate = this._formatDate(o, i)), "disabled" in s && (s.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)), this._attachments(V(t), o), this._autoSize(o), this._setDate(o, n), this._updateAlternate(o), this._updateDatepicker(o))
        },
        ...
        _checkOffset: function (t, e, i) {
            var s = t.dpDiv.outerWidth(),
                ...
                h = document.documentElement.clientHeight + (i ? 0 : V(document).scrollTop());
            return e.left -= this._get(t, "isRTL") ? s - o : 0, e.left -= i && e.left === t.input.offset().left ? V(document).scrollLeft() : 0, e.top -= i && e.top === t.input.offset().top + a ? V(document).scrollTop() : 0, e.left -= Math.min(e.left, e.left + s > r && s < r ? Math.abs(e.left + s - r) : 0), e.top -= Math.min(e.top, e.top + n > h && n < h ? Math.abs(n + a) : 0), e
        },
        _findPos: function (t) {
        ...
        parseDate: function (e, n, t) {
            ...
            for (var i, s, o, a = 0, r = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, r = "string" != typeof r ? r : (new Date).getFullYear() % 100 + parseInt(r, 10), h = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, l = (t ? t.dayNames : null) || this._defaults.dayNames, c = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, u = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, p = -1, f = -1, g = -1, m = !1, _ = function (t) {
        ...
        _generateHTML: function (t) {
            var e, i, s, n, o, a, r, h, l, c, u, d, p, f, g, m, _, v, b, y, w, x, k, C, D, I, P, T, M, S, H, z, O = new Date,
            ...
            for (t.drawMonth = K, t.drawYear = U, R = this._get(t, "prevText"), R = F ? this.formatDate(R, this._daylightSavingAdjust(new Date(U, K - O, 1)), this._getFormatConfig(t)) : R, i = this._canAdjustMonth(t, -1, U, K) ? V("<a>").attr({
                ...
                title: R
            }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (N ? "e" : "w")).text(R))[0].outerHTML, R = this._get(t, "nextText"), R = F ? this.formatDate(R, this._daylightSavingAdjust(new Date(U, K + O, 1)), this._getFormatConfig(t)) : R, s = this._canAdjustMonth(t, 1, U, K) ? V("<a>").attr({
                ...
                title: R
            }).append(V("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (N ? "w" : "e")).text(R))[0].outerHTML, O = this._get(t, "currentText"), W = this._get(t, "gotoCurrent") && t.currentDay ? B : A, O = F ? this.formatDate(O, W, this._getFormatConfig(t)) : O, R = "", t.inline || (R = V("<button>").attr({
                type: "button",
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
            var h, l, c, u, d, p, f = this._get(t, "changeMonth"),
            ...
            if (o || !f) y += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
                ...
                for (h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, y += "<select class='ui-datepicker-month' aria-label='" + _ + "' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!h || c >= s.getMonth()) && (!l || c <= n.getMonth()) && (y += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + r[c] + "</option>");
                y += "</select>"
            }
    ...
    }, V.datepicker = new b, V.datepicker.initialized = !1, V.datepicker.uuid = (new Date).getTime(), V.datepicker.version = "1.13.0";
    V.datepicker;
    V.widget("ui.dialog", {
        version: "1.13.0",
        options: {
    ...
    V.ui.dialog, V.widget("ui.progressbar", {
        ...
        _mouseCapture: function (t) {
            ...
            return !h.disabled && (this.elementSize = {
                ...
                (e < s || s === e && (t === r._lastChangedValue || r.values(t) === h.min)) && (s = e, n = V(this), o = t)
        ...
        _refreshValue: function () {
            ...
            this._hasMultipleValues() ? this.handles.each(function (t) {
                i = (r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, l["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", V(this).stop(1, 1)[h ? "animate" : "css"](l, a.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === t && r.range.stop(1, 1)[h ? "animate" : "css"]({
                    left: i + "%"
    ...
    V.widget("ui.tabs", {
        ...
        _processTabs: function () {
            ...
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", function (t) {
                ...
                h._isLocal(e) ? (n = (i = e.hash).substring(1), s = h.element.find(h._sanitizeSelector(i))) : (n = a.attr("aria-controls") || V({}).uniqueId()[0].id, (s = h.element.find(i = "#" + n)).length || (s = h._createPanel(n)).insertAfter(h.panels[t - 1] || h.tablist), s.attr("aria-live", "polite")), s.length && (h.panels = h.panels.add(s)), r && a.data("ui-tabs-aria-controls", r), a.attr({
                    "aria-controls": n,
                    "aria-labelledby": o
    ...
    function B(t) {
        return null == t ? t + "" : "object" == typeof t ? z[O.call(t)] || "object" : typeof t
    }
        ...
        transition: function (t, a) {
            ...
            return Y(i.props, function (t, e) {
                var i = e.idx,
                    ...
                    n = l[i],
                    o = F[e.type] || {};
                null !== n && (null === s ? h[i] = n : (o.mod && (n - s > o.mod / 2 ? s += o.mod : s - n > o.mod / 2 && (s -= o.mod)), h[i] = j((n - s) * a + s, e)))
            }), this[e](h)
        },
        blend: function (t) {
        ...
        E.fn[h] = function (t) {
            ...
            E.fn[a] || (E.fn[a] = function (t) {
                var e, i = B(t),
                    ...
                    n = this[s](),
                    o = n[r.idx];
                return "undefined" === i ? o : ("function" === i && (i = B(t = t.call(this, o))), null == t && r.empty ? this : ("string" === i && (e = A.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), n[r.idx] = t, this[s](n)))
            })
        })
    }), (E.hook = function (t) {
        t = t.split(" ");
    ...
    V.effects = {
        ...
        effect: function () {
            function t(t) {
                ...
                e.data(at, !0), h.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || V.effects.saveStyle(e), "function" == typeof t && t()
            }
            var s = ht.apply(this, arguments),
            ...
            function l(t) {
                ...
                s.mode = h.shift(), !1 === V.uiBackCompat || o ? "none" === s.mode ? (e[r](), i()) : n.call(e[0], s, function () {
                    e.removeData(at), V.effects.cleanUp(e), "hide" === s.mode && e.hide(), i()
                }) : (e.is(":hidden") ? "hide" === r : "show" === r) ? (e[r](), i()) : n.call(e[0], s, i)
            }
        },
        show: (et = V.fn.show, function (t) {
            if (lt(t)) return et.apply(this, arguments);
            t = ht.apply(this, arguments);
            return t.mode = "show", this.effect.call(this, t)
        }),
        hide: (tt = V.fn.hide, function (t) {
            if (lt(t)) return tt.apply(this, arguments);
            t = ht.apply(this, arguments);
            return t.mode = "hide", this.effect.call(this, t)
        }),
        toggle: (Z = V.fn.toggle, function (t) {
            if (lt(t) || "boolean" == typeof t) return Z.apply(this, arguments);
            t = ht.apply(this, arguments);
        ...
        transfer: function (t, e) {
            var i = V(this),
                ...
                s = i.offset(),
                h = V("<div class='ui-effects-transfer'></div>");
    ...
    R = V.effects, V.effects.define("blind", "hide", function (t, e) {
        ...
        var i, s, n = V(this),
            ...
            g = 0,
            t = n.queue().length;
        for (V.effects.createPlaceholder(n), h = n.css(p), l = l || n["top" == p ? "outerHeight" : "outerWidth"]() / 3, r && ((s = {
            opacity: 1
        ...
        a && ((i = {
            opacity: 0
        })[p] = (f ? "-=" : "+=") + l, n.animate(i, u, d)), n.queue(e), V.effects.unshift(n, t, 1 + o)
        ...
        V.effects.createPlaceholder(i), n = t.distance || i["top" == o ? "outerHeight" : "outerWidth"](!0) / 2, h[o] = a + n, s && (i.css(h), h[o] = r + n, h.opacity = 1), i.animate(h, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: e
        ...
        var i = V(this),
            ...
            f = [u[h[0]], u[h[1]]],
            s = i.queue().length;
        r && (a = parseInt(r[1], 10) / 100 * f[o ? 0 : 1]), d.clip[h[0]] = a, p.clip[h[0]] = a, p.clip[h[1]] = 0, n && (i.cssClip(p.clip), c && c.css(V.effects.clipToBox(p)), p.clip = u), i.queue(function (t) {
            c && c.animate(V.effects.clipToBox(d), l, e.easing).animate(V.effects.clipToBox(p), l, e.easing), t()
        }).animate(d, l, e.easing).animate(p, l, e.easing).queue(t), V.effects.unshift(i, s, 4)
        ...
        V.effects.createPlaceholder(i), "show" === r && (r = f, f = g, g = r), n = {
            ...
            n.from.y !== n.to.y && (i = V.effects.setTransition(t, o, n.from.y, i), e = V.effects.setTransition(t, o, n.to.y, e)), n.from.x !== n.to.x && (i = V.effects.setTransition(t, a, n.from.x, i), e = V.effects.setTransition(t, a, n.to.x, e)), h && V.effects.saveStyle(t), t.css(i), t.animate(e, s.duration, s.easing, function () {
                h && V.effects.restoreStyle(t)
            })
        })), i.animate(g, {
            queue: !1,
            duration: s.duration,
            ...
            complete: function () {
                var t = i.offset();
                0 === g.opacity && i.css("opacity", f.opacity), h || (i.css("position", "static" === u ? "relative" : u).offset(t), V.effects.saveStyle(i)), e()
            }
        })
        ...
        var i = 1,
            ...
            p = {},
            n = s.queue().length;
        for (V.effects.createPlaceholder(s), u[l] = (c ? "-=" : "+=") + o, d[l] = (c ? "+=" : "-=") + 2 * o, p[l] = (c ? "-=" : "+=") + 2 * o, s.animate(u, h, t.easing); i < a; i++) s.animate(d, h, t.easing).animate(p, h, t.easing);
        s.animate(d, h, t.easing).animate(u, h / 2, t.easing).queue(e), V.effects.unshift(s, n, 1 + r)
        ...
        var i, s, n = V(this),
            ...
            u = {};
        V.effects.createPlaceholder(n), i = n.cssClip(), s = n.position()[h], u[h] = (l ? -1 : 1) * c + s, u.clip = n.cssClip(), u.clip[o[r][1]] = u.clip[o[r][0]], "show" === a && (n.cssClip(u.clip), n.css(h, u[h]), u.clip = i, u[h] = s), n.animate(u, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: e
